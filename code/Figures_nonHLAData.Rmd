---
title: "Script to create figures related to the non-HLA PeptideAtlas build"
...
ubiquitination_file <- file.path(raw_dir, "VanHeesch_EDtable5.xlsx")
```
