...
ggsave("Figure_2IJ.svg",
  ...
  width = 2700, height = 525, units = "px"
)
```
...
# Figure S6 - Binding predictions
## Figure S6AB - 9mers per hla-typing
...
```{r}
figure_s6ab <- figure_s6a + figure_s6b

ggsave("Figure_S6AB.svg",
  device = "svg", path = plot_dir, figure_s6ab,
  width = 1100, height = 1000, units = "px"
)
```

## Figure S6G - Ligand Atlas quality
...
ggsave("figure_S6G.svg",
  device = "svg", path = plot_dir, figure_s6g,
  width = 1237.205, height = 600, units = "px"
)
```

## Figure S6H - LigandAtlas - GTEX comparison
```{r}
...
ggsave("Figure_S6H.svg",
  device = "svg", path = plot_dir, figure_s6h,
  width = 1300, height = 800, units = "px"
)
```

# Figure S8 - ORF examples
## Figure S8A - nonHLA c11riboseqorf4
```{r}
b_w <- 0.7
...
ggsave("Figure_S8A.svg",
  device = "svg", path = plot_dir, figure_s8a,
  width = 2200, height = 300, units = "px"
)
```

## Figure S8B - HLA c17norep146
...
ggsave("Figure_S8B.svg",
  device = "svg", path = plot_dir, figure_s8b,
