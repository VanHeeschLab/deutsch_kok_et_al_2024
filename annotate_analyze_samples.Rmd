...
# File containing the sequences of proteins/ncORFs from PeptideAtlas
...
annotation_file <- file.path(raw_dir, "20231208_AnnotatedInjections.xlsx")
...
atlas_stats_nonhla_file <- 
  file.path(raw_dir, "exp_contrib_table_guest_20240130-020814-950.tsv")
